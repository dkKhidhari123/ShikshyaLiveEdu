...
import { Phone, Mail, BookOpen, HelpCircle, Shield } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/courses" className="text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400">
                  Courses
                </Link>
              </li>
              <li>
                <Link to="/schedule" className="text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400">
                  Schedule
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/support" className="text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 flex items-center">
                  <HelpCircle size={16} className="mr-1" />
                  FAQ
                </Link>
              </li>
              <li>
                <a href="tel:9263978607" className="text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 flex items-center">
                  <Phone size={16} className="mr-1" />
                  9263978607
                </a>
              </li>
              <li>
                <a href="mailto:dk5757khidhari@gmail.com" className="text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 flex items-center">
                  <Mail size={16} className="mr-1" />
                  dk5757khidhari@gmail.com
                </a>
              </li>
              <li>
                <Link to="/support/help-center" className="text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400">
                  Help Center
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/privacy-policy" className="text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 flex items-center">
              ...
              <li>
                <Link to="/accessibility" className="text-gray-600 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400">
                  Accessibility
                </Link>
              </li>
            </ul>
